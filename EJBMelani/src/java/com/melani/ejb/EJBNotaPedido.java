...
public StringBuilder parsearCaracteresEspecialesXML(String xmlNota){
    ...
    public String selectAllNotas() {
        ...
        try {
            ...
            Query consulta =em.createQuery("SELECT n FROM Notadepedido n ORDER BY n.id DESC, n.fechadecompra DESC");
        ...
        try {
           ...
           List<Detallesnotadepedido>lista=nota.getDetallesnotadepedidoList();
            for (Iterator<Detallesnotadepedido> it = lista.iterator(); it.hasNext();) {
                logger.warn("------------------------------------------------------");
                Detallesnotadepedido detallesnotadepedido = it.next();
                logger.warn("id nota "+detallesnotadepedido.getNotadepedido().getId());
                logger.warn("anulado "+detallesnotadepedido.getAnulado());
                logger.warn("cancelado "+detallesnotadepedido.getCancelado());
                logger.warn("cantidad "+detallesnotadepedido.getCantidad());
                logger.warn("descuento "+detallesnotadepedido.getDescuento());
                logger.warn("entregado "+detallesnotadepedido.getEntregado());
                logger.warn("iva "+detallesnotadepedido.getIva());
                logger.warn("pendiente "+detallesnotadepedido.getPendiente());
                logger.warn("precio "+detallesnotadepedido.getPrecio());
                logger.warn("preciodescuento "+detallesnotadepedido.getPreciocondescuento());
                logger.warn("idproducto "+detallesnotadepedido.getProductos().getSid());
                logger.warn("subtotal "+detallesnotadepedido.getSubtotal());
                logger.warn("------------------------------------------------------");
            }
           logger.warn("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
