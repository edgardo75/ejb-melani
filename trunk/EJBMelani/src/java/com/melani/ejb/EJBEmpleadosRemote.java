...
public interface EJBEmpleadosRemote {
    ...
    long addEmpleadoFullTime(String apellido,String nameuser, String nombre, String password, String passwordre, String email, short idtipoDocu, int numerodocu, float salario,short idGenero,String Observaciones);
