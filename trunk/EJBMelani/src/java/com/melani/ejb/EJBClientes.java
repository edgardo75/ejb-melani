...
public String ShowReportClient() {
        ...
        try {
            ...
            logger.error("Error en metodo ShowReportClient",e.getCause());
        }finally{
            try {
                if (con != null) {
                    con.close();
                ...
                if (oxq != null) {
                    ...
                    java.util.logging.Logger.getLogger(EJBClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            }
            return xml;
        }
    }
