...
public class EJBHistoricoPersonaDomicilioBean implements EJBHistoricoPersonaDomicilioRemote {
    ...
    public String searchAllHistPD() {
        ...
        try {
            ...
            //*********************************************************************************
            String sql= "SELECT HISTPERSONASDOMICILIOS.IDDOMICILIO,HISTPERSONASDOMICILIOS.IDPERSONA FROM HISTPERSONASDOMICILIOS ORDER BY HISTPERSONASDOMICILIOS.IDPERSONA,HISTPERSONASDOMICILIOS.IDDOMICILIO";
